    ...
    return (
        <Modal>
            ...
            <Formulario>
                ...
                <input type="text" id="lanzamiento-fecha" name="lanzamiento-fecha"  value={fechaLanzamiento} onChange={(e) => setFechaLanzamiento(e.target.value)} />
                ...
                <div className="row">
                    <input type="number" value={precioMin} onChange={(e) => setPrecioMin(Number(e.target.value))} />
                    <span>a</span>
                    <input type="number" value={precioMax} onChange={(e) => setPrecioMax(Number(e.target.value))} />
                </div>
            </Formulario>
